...
const TEST_FILES = ['smoke.js', 'stdio.test.js', 'http.test.js', 'gate.test.js', 'management.test.js', 'mode.test.js', 'reference-gate.test.js', 'logging.test.js', 'proxy.test.js', 'reload.test.js', 'lean-forward.test.js', 'reconnect.test.js', 'matrix.test.js', 'ui-matrix.test.js', 'hidden.test.js', 'auth.test.js', 'audit-log.test.js', 'tool-editor.test.js', 'install.test.js', 'spawn-shim.test.js', 'server-config.test.js', 'integration-real-mcp.test.js', 'integration-http-client.test.js', 'release.test.js'];
